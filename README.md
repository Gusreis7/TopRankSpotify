...
## Hello there
To run this code, you'll need your streaming data from spotify. You can get it from spotify website, by ordering your data in your privacity settings, I sugest you order the complete history data, because that includes your whole history of streaming in spotify since the creation of your account.
